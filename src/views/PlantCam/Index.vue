<template>
  <div>
    <Navbar />
    <div class="flex items-center gap-5 justify-center py-40">
      <div class="p-5 border-2 border-black flex flex-col rounded-lg text-center justify-center items-center gap-5 w-[250px] h-[200px]">
        <div class="w-10 h-10">
